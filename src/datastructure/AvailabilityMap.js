(function (exports) {
    ...
    var AvailabilityMapBase=
            (require('./AvailabilityMapBase.js')|| jsd.datastructure).AvailabilityMapBase;

    exports.AvailabilityMap = AvailabilityMapBase.subClass({
        name:'jsd.datastructure.AvailabilityMap',
...
})(typeof exports === 'undefined' ? jsd.datastructure : exports);
