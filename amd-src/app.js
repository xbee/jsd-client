...
} else if (typeof define === 'function' && define.amd) { define('jsd', ['require', 'exports', 'module', 'exports', 'lodash', 'q', 'node-uuid', 'observe-js', 'sockjs-client'], factory) } else throw new Error('uRequire: Loading UMD module as <script>, without `build.noLoaderUMD`');
