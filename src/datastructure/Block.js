(function(){
    jsd.core.Block = Object.subClass({
        name:'jsd.core.Block',
        ...
        ctor:function(blockSize,buffer,verified) {
            ...
            this.length = Math.ceil(this.blockSize/jsd.config.CHUNK_SIZE); //numOfChunks
...
//        },
        ...
        getChunk: function(chunkOffset) {
            if (this.verified) {
                    if(this.buffer) {
                        var startOffset = chunkOffset * jsd.config.CHUNK_SIZE; //inclusive
                        var endOffset = (1+chunkOffset) * jsd.config.CHUNK_SIZE; //exclusive
        ...
        setChunk:function(chunkOffset, chunkData) {
            ...
            var byteOffset = chunkOffset * jsd.config.CHUNK_SIZE;
