...
} else if (typeof define === 'function' && define.amd) { define(['require', 'exports', 'module', 'urequire', 'observe-js', 'sockjs-client'], factory) } else throw new Error('uRequire: Loading UMD module as <script>, without `build.noLoaderUMD`');
